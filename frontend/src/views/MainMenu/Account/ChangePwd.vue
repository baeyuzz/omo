                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td> <input class="regInput"  v-model="prePwd" type="password"/></td>
                            </tr>
                            <tr>
                                <td><label>새로운 비밀번호</label></td>
                                <td> <input class="regInput"  v-model="newPwd" type="password"/></td>
                            </tr>
                            <tr>
                                <td><label>비밀번호 확인</label></td>
                                <td><input class="regInput" v-model="newPwd2" type="password"/></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="regForm">
                    <button class="regBtn" @click=submitForm()>변경</button>
                </div>
            </div>
        </div>
  </div>
