...
//             return null;
//         }
//         Client client = new Client(clientDocument.getString("phone"),
//                 clientDocument.getString("voice"),
//                 clientDocument.getString("name"),
//                 clientDocument.getInteger("age"),
//                 clientDocument.getDate("visitedDate"),
//                 clientDocument.getBoolean("isAdmin"));
...
//         document.put("voice", client.getVoice());
//         document.put("name", client.getName());
//         document.put("age", client.getAge());
//         document.put("visitedDate", client.getVisitedDate());
//         document.put("isAdmin", client.isAdmin());
//         return document;
//     }
// }
